...
if __name__ == "__main__":
    ...
    candidates=sql_select("SELECT ca.id,c.nome,c.cpf,c.nomeFilial,c.cadastro,c.cargo,c.createdAt,ca.name,ca.cpf,ca.senior_num_can,ca.previous_lunelli_cad,ca.previous_lunelli_unit,ca.previous_lunelli_job,ca.previous_lunelli_date  FROM b2blunender.Colaborador c JOIN lunellicarreiras.candidates ca ON ca.cpf=c.cpf WHERE ca.previous_lunelli_cad IS NULL AND ca.senior_num_can IS NULL",main_sql_conn)
