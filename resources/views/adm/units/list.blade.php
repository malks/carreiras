...
@section('title', 'Unidades | Lunelli Carreiras')
...
@section('content')
	<form method='GET' action='/adm/units' id='app'>
		@csrf
	    <div class="card" check-units-list>
	        ...
	        <div class="card-body">
	        	<div class='row'>
	        		<div class="col-1">
	        			<a class="btn btn-primary" id='new' href='/adm/units/create'>Nova</a>
	        		</div>
	        		<div class="col-1">
