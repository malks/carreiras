...
@section('title', 'Funções de Usuários | Lunelli Carreiras')
...
@section('content')
	<form method='GET' action='/adm/roles' id='app'>
		@csrf
	    <div class="card" check-roles-list>
	    	<div class='card-header'>
	    		<h5>Funções de Usuários</h5>
	    	</div>
	        <div class="card-body">
	        	<div class='row'>
	        		<div class="col-1">
	        			<a class="btn btn-primary" id='new' href='/adm/roles/create'>Nova</a>
	        		</div>
	        		<div class="col-1">
