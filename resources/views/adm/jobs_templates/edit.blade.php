...
@section('title', 'Edição de Template de Vaga | Lunelli Carreiras')
...
@section('content')
    ...
    @endif
	<form method='POST' action='/adm/jobs-templates/save' enctype='multipart/form-data'>
		@csrf
	    <div class="card" check-jobs-templates-edit>
	    	<div class='card-header'>
	    		<h5>Edição de Template de Vaga</h5>
	    	</div>
	        <div class="card-body">
	        	<div class='row'>
	        		<div class=" col-sm-12 col-lg-1">
	        			<a class="btn btn-secondary" href='/adm/jobs-templates'>Voltar</a>
	        		</div>
	        		<div class=" col-sm-12 col-lg-1">
                ...
                <div class="row margin-top-10">
                    <div class="col-lg-2">
                        ...
                        <input type="text" class='form-control text-right' value='{{$data->cod_senior}}'>
                    </div>
                    <div class="col-lg-2">
                        <label for="">Código Estrutura do Cargo Senior</label>
                        <input type="text" class='form-control text-right' value='{{$data->cod_est_senior}}'>
                    </div>
                    <div class="col-lg-2">
                        <label for="">Código Hierarquia do Cargo Senior</label>
                        <input type="text" class='form-control text-right' value='{{$data->cod_hie_senior}}'>
                    </div>
                </div>
                <div class="row margin-top-10">
                ...
                <div class="row margin-top-10" id='jobs-templates-tags'>
                    <div class=" col-sm-12 col-lg">
