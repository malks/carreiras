...
class CandidateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('candidates')->insert(['user_id'=>'2','email'=>'osmar@nbwdigital.com.br','phone'=>'4799999999','name'=>'osmar gascho','cpf'=>'cpfzim','address_street'=>'rua do mal','address_district'=>'aguaverd','address_city'=>'jgua do sul','address_state'=>'Santa catarina','address_country'=>'Brasil','zip'=>'89250000','cv'=>'','dob'=>'1900-01-01']);
    }
}